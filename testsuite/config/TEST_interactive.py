...
class Test_UserInputInterface(object):
	...
	(('Please enter [yes]: ',), {})
	0000-00-00 00:00:00 - console.input:CRITICAL - Invalid input "Hallo"! Answer with "yes" or "no"
	(('Please enter [yes]: ',), {})
	0000-00-00 00:00:00 - console.input:CRITICAL - Invalid input "Welt"! Answer with "yes" or "no"
	(('Please enter [yes]: ',), {})
	True
