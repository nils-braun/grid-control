...
class Test_ProcessLogging:
	...
	>>> p1 = LocalProcess('io_test', 'Hallo', '"Welt !"', env_dict={'GC_TEST_STDOUT': 'log.stdout', 'GC_TEST_STDERR': 'log.stderr', 'GC_TEST_RET': '123'})
	...
	>>> p2 = LocalProcess('io_test', 'Hallo', '"Welt !"', env_dict={'GC_TEST_RET': '0'})
