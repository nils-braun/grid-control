...
class Test_ScanProvider:
	...
	BlockName  = f9696770
	Dataset    = /PRIVATE/Dataset_b67d992fd0937b1f13a8dcfa016d5913
	FileList   = ["URL=./test_Zee_0.root NEntries=-1 Metadata={BLOCK_KEY = 'f969677035fe8232d5a4a08b8e8f505a', DELIMETER_DS = 'Zee', DS_KEY = 'b67d992fd0937b1f13a8dcfa016d5913', FILE_SIZE = 3, GC_SOURCE_DIR = 'file://.', PARENT_PATH = ['/PRIVATE/Zee']}"]
	Locations  = None
	Metadata   = {BLOCK_KEY, DELIMETER_DS, DS_KEY, FILE_SIZE, GC_SOURCE_DIR, PARENT_PATH}
	NEntries   = -1
